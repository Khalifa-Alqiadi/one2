    ...
    <div class="padding">
        ...
        <div class="box nav-active-border b-info">
            <ul class="nav nav-md">
                ...
                <li class="nav-item inline {{ $WebmasterSections->type == 10 ? 'displayNone' : '' }}"
                    id="custom-fields-tab-link">
            ...
            <div class="tab-content clear b-t">
                <div class="tab-pane  {{ $tab_1 }}" id="tab_details">
                    <div class="box-body p-a-2">
                        <form method="POST" action="{{ route('WebmasterSectionsUpdate', $WebmasterSections->id) }}"
                            class="dashboard-form" enctype="multipart/form-data">
                            @csrf

                            @foreach (Helper::languagesList() as $ActiveLanguage)
                                <div class="form-group row">
                                    <label class="col-sm-2 form-control-label">{!! __('backend.sectionName') !!}
                                        {!! @Helper::languageName($ActiveLanguage) !!}
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" autocomplete="off" name="title_{{ @$ActiveLanguage->code }}"
                                            id="title_{{ @$ActiveLanguage->code }}"
                                            value="{{ $WebmasterSections->{'title_' . @$ActiveLanguage->code} }}" required
                                            maxlength="191" dir="{{ @$ActiveLanguage->direction }}" class="form-control" />
                                    </div>
                                </div>
                            @endforeach
                            <div class="form-group row">
                                    ...
                                    <div class="radio secs">
                                        <div>
                                            <label
                                                ...
                                                <input type="radio" name="type" value="0" class="has-value"
                                                    {{ $WebmasterSections->type == 0 ? 'checked' : '' }} id="site_status1">
                                        ...
                                        <div>
                                            <label
                                                class="ui-check ui-check-md p-y-sm w-100 p-x-2 b-a  {{ $WebmasterSections->type == 10 ? 'sec-active' : '' }}">
                                                <input type="radio" name="type" value="10" class="has-value"
                                                    {{ $WebmasterSections->type == 10 ? 'checked' : '' }} id="site_status11">
                                                <i class="dark-white"></i>
                                        ...
                                        <div>
                                            <label
                                                ...
                                                <input type="radio" name="type" value="1" class="has-value"
                                                    {{ $WebmasterSections->type == 1 ? 'checked' : '' }} id="site_status2">
                                                <i class="dark-white"></i>
                                        ...
                                        <div>
                                            <label
                                                ...
                                                <input type="radio" name="type" value="2" class="has-value"
                                                    {{ $WebmasterSections->type == 2 ? 'checked' : '' }} id="site_status3">
                                                <i class="dark-white"></i>
                                        ...
                                        <div>
                                            <label
                                                ...
                                                <input type="radio" name="type" value="3" class="has-value"
                                                    {{ $WebmasterSections->type == 3 ? 'checked' : '' }} id="site_status4">
                                                <i class="dark-white"></i>
                                        ...
                                        <div>
                                            <label
                                                ...
                                                <input type="radio" name="type" value="5" class="has-value"
                                                    {{ $WebmasterSections->type == 5 ? 'checked' : '' }} id="site_status6">
                                                <i class="dark-white"></i>
                                                <div class="p-a-sm rounded accent pull-left m-r">
                                                    <span class="fa fa-table sec-icon"></span>
                                                </div>
                                        ...
                                        <div>
                                            <label
                                                ...
                                                <input type="radio" name="type" value="8" class="has-value"
                                                    {{ $WebmasterSections->type == 8 ? 'checked' : '' }} id="site_status9">
                                                <i class="dark-white"></i>
                                                <div class="p-a-sm rounded teal pull-left m-r">
                                                    <span class="material-icons sec-icon">&#xe896;</span>
                                                </div>
                                                <strong>{{ __('backend.accordionSection') }}</strong>
                                                <div class="m-x-sm text-muted">{{ __('backend.accordionSectionDesc') }}
                                                </div>
                                            </label>
                                        </div>
                                        <div>
                                            <label
                                                class="ui-check ui-check-md p-y-sm w-100 p-x-2 b-a  {{ $WebmasterSections->type == 9 ? 'sec-active' : '' }}">
                                                <input type="radio" name="type" value="9" class="has-value"
                                                    {{ $WebmasterSections->type == 9 ? 'checked' : '' }} id="site_status10">
                                                <i class="dark-white"></i>
                                                <div class="p-a-sm rounded orange pull-left m-r">
                                                    <span class="material-icons sec-icon">&#xe2c8;</span>
                                                </div>
                                                <strong>{{ __('backend.documentationSection') }}</strong>
                                                <div class="m-x-sm text-muted">
                                                    {{ __('backend.documentationSectionDesc') }}</div>
                                            </label>
                                        </div>
                                        <div>
                                            <label
                                                class="ui-check ui-check-md p-y-sm w-100 p-x-2 b-a  {{ $WebmasterSections->type == 4 ? 'sec-active' : '' }}">
                                                <input type="radio" name="type" value="4" class="has-value"
                                                    {{ $WebmasterSections->type == 4 ? 'checked' : '' }} id="site_status5">
                                                <i class="dark-white"></i>
                                        ...
                                        <div>
                                            <label
                                                ...
                                                <input type="radio" name="type" value="7" class="has-value"
                                                    {{ $WebmasterSections->type == 7 ? 'checked' : '' }} id="site_status8">
                                                <i class="dark-white"></i>
                                        ...
                                        <div>
                                            <label
                                                class="ui-check ui-check-md p-y-sm w-100 p-x-2 b-a  {{ $WebmasterSections->type == 6 ? 'sec-active' : '' }}">
                                                <input type="radio" name="type" value="6" class="has-value"
                                                    {{ $WebmasterSections->type == 6 ? 'checked' : '' }} id="site_status7">
                                                <i class="dark-white"></i>
                                    ...
                                    <div class="radio b-a p-a">
                                        <div>
                                            <label class="md-check">
                                                <input type="radio" name="sections_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->sections_status == 0 ? 'checked' : '' }}
                                                    id="sections_status1">
                                                <i class="primary"></i>
                                        ...
                                        <div>
                                            <label class="md-check">
                                                <input type="radio" name="sections_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->sections_status == 1 ? 'checked' : '' }}
                                                    id="sections_status2">
                                                <i class="primary"></i>
                                        ...
                                        <div>
                                            <label class="md-check">
                                                <input type="radio" name="sections_status" value="2"
                                                    class="has-value"
                                                    {{ $WebmasterSections->sections_status == 2 ? 'checked' : '' }}
                                                    id="sections_status3">
                                                <i class="primary"></i>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="radio b-a p-a">
                                        <div>
                                            <label class="md-check">
                                                <input type="radio" name="sportmonks_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->sportmonks_status == 0 ? 'checked' : '' }}
                                                    id="sportmonks_status1">
                                                <i class="primary"></i>
                                        ...
                                        <div>
                                            <label class="md-check">
                                                <input type="radio" name="sportmonks_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->sportmonks_status == 1 ? 'checked' : '' }}
                                                    id="sportmonks_status2">
                                                <i class="primary"></i>
                                                {{ __('backend.leagues') }}
                                            </label>
                                        </div>
                                        <div>
                                            <label class="md-check">
                                                <input type="radio" name="sportmonks_status" value="2"
                                                    class="has-value"
                                                    {{ $WebmasterSections->sportmonks_status == 2 ? 'checked' : '' }}
                                                    id="sportmonks_status3">
                                                <i class="primary"></i>
                                                {{ __('backend.teams') }}
                                            </label>
                                        </div>
                                        <div>
                                            <label class="md-check">
                                                <input type="radio" name="sportmonks_status" value="3"
                                                    class="has-value"
                                                    {{ $WebmasterSections->sportmonks_status == 3 ? 'checked' : '' }}
                                                    id="sportmonks_status4">
                                                <i class="primary"></i>
                                                {{ __('backend.matches') }}
                                            </label>
                                        </div>
                            ...
                            <div id="fields_settings" class="{{ $WebmasterSections->type == 10 ? 'displayNone' : '' }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="title_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->title_status == 1 ? 'checked' : '' }}
                                                    id="title_status1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="title_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->title_status == 0 ? 'checked' : '' }}
                                                    id="title_status2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="date_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->date_status == 1 ? 'checked' : '' }}
                                                    id="date_status1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="date_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->date_status == 0 ? 'checked' : '' }}
                                                    id="date_status2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="expire_date_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->expire_date_status == 1 ? 'checked' : '' }}
                                            ...
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="expire_date_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->expire_date_status == 0 ? 'checked' : '' }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="longtext_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->longtext_status == 1 ? 'checked' : '' }}
                                                    id="longtext_status1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="longtext_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->longtext_status == 0 ? 'checked' : '' }}
                                                    id="longtext_status2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="editor_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->editor_status == 1 ? 'checked' : '' }}
                                                    id="editor_status1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="editor_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->editor_status == 0 ? 'checked' : '' }}
                                                    id="editor_status2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="tags_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->tags_status == 1 ? 'checked' : '' }}
                                                    id="tags_status1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="tags_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->tags_status == 0 ? 'checked' : '' }}
                                                    id="tags_status0">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                        ...
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="case_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->case_status == 1 ? 'checked' : '' }}
                                                    id="case_status1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="case_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->case_status == 0 ? 'checked' : '' }}
                                                    id="case_status2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                ...
                                <div class="form-group row">
                                    <label for="featured_status1"
                                        class="col-sm-2 form-control-label">{!! __('backend.featuredField') !!}</label>
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="featured_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->featured_status == 1 ? 'checked' : '' }}
                                                    id="featured_status1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="featured_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->featured_status == 0 ? 'checked' : '' }}
                                                    id="featured_status2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="visits_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->visits_status == 1 ? 'checked' : '' }}
                                                    id="visits_status1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="visits_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->visits_status == 0 ? 'checked' : '' }}
                                                    id="visits_status2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="photo_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->photo_status == 1 ? 'checked' : '' }}
                                                    id="photo_status1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="photo_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->photo_status == 0 ? 'checked' : '' }}
                                                    id="photo_status2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="attach_file_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->attach_file_status == 1 ? 'checked' : '' }}
                                            ...
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="attach_file_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->attach_file_status == 0 ? 'checked' : '' }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="section_icon_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->section_icon_status == 1 ? 'checked' : '' }}
                                            ...
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="section_icon_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->section_icon_status == 0 ? 'checked' : '' }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="icon_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->icon_status == 1 ? 'checked' : '' }}
                                                    id="icon_status1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="icon_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->icon_status == 0 ? 'checked' : '' }}
                                                    id="icon_status2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="no_status" value="1" class="has-value"
                                                    {{ $WebmasterSections->no_status == 1 ? 'checked' : '' }}
                                                    id="no_status1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="no_status" value="0" class="has-value"
                                                    {{ $WebmasterSections->no_status == 0 ? 'checked' : '' }}
                                                    id="no_status2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                ...
                                <div class="form-group row">
                                    <label for="index_status1"
                                        class="col-sm-2 form-control-label">{!! __('backend.allowInstantIndexing') !!}</label>
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="index_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->index_status == 1 ? 'checked' : '' }}
                                                    id="index_status1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="index_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->index_status == 0 ? 'checked' : '' }}
                                                    id="index_status2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                            ...
                            <div id="tabs_settings" class="{{ $WebmasterSections->type == 10 ? 'displayNone' : '' }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="multi_images_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->multi_images_status == 1 ? 'checked' : '' }}
                                            ...
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="multi_images_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->multi_images_status == 0 ? 'checked' : '' }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="extra_attach_file_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->extra_attach_file_status == 1 ? 'checked' : '' }}
                                            ...
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="extra_attach_file_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->extra_attach_file_status == 0 ? 'checked' : '' }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="maps_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->maps_status == 1 ? 'checked' : '' }}
                                                    id="maps_status1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="maps_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->maps_status == 0 ? 'checked' : '' }}
                                                    id="maps_status2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                        ...
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="order_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->order_status == 1 ? 'checked' : '' }}
                                                    id="order_status1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="order_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->order_status == 0 ? 'checked' : '' }}
                                                    id="order_status2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="comments_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->comments_status == 1 ? 'checked' : '' }}
                                                    id="comments_status1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="comments_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->comments_status == 0 ? 'checked' : '' }}
                                                    id="comments_status2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="related_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->related_status == 1 ? 'checked' : '' }}
                                                    id="related_status1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="related_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->related_status == 0 ? 'checked' : '' }}
                                                    id="related_status2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="seo_status" value="1" class="has-value"
                                                    {{ $WebmasterSections->seo_status == 1 ? 'checked' : '' }}
                                                    id="seo_status1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="seo_status" value="0" class="has-value"
                                                    {{ $WebmasterSections->seo_status == 0 ? 'checked' : '' }}
                                                    id="seo_status2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                ...
                                <div class="form-group row">
                                    <label for="code_status1"
                                        class="col-sm-2 form-control-label">{!! __('backend.customCode') !!}</label>
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="code_status" value="1"
                                                    class="has-value"
                                                    {{ $WebmasterSections->code_status == 1 ? 'checked' : '' }}
                                                    id="code_status1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="code_status" value="0"
                                                    class="has-value"
                                                    {{ $WebmasterSections->code_status == 0 ? 'checked' : '' }}
                                                    id="code_status2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                            ...
                            <div class="form-group">
                                <br />
                                <label>
                                    <h5><i class="material-icons">&#xe8a4;</i> {{ __('backend.extra') }}
                                    </h5>
                                </label>
                                <hr class="m-a-0">
                            </div>
                                        ...
                                        @if ($WebmasterSections->photo != '')
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="hidden" name="photo_delete" id="photo_delete"
                                                        value="0">
                                                </div>
                                            </div>
                                        @endif
                                        ...
                                        <select name="popup_id" id="popup_id" class="form-control c-select">
                                            ...
                                            @foreach (\App\Models\Popup::where('status', 1)->get() as $PPopup)
                                                <option value="{{ $PPopup->id }}"
                                                    {{ $PPopup->id == $WebmasterSections->popup_id ? "selected='selected'" : '' }}>
                                    ...
                                    <div class="radio">
                                        <label class="md-check">
                                            <input type="radio" name="status" value="1" class="has-value"
                                                {{ $WebmasterSections->status == 1 ? 'checked' : '' }} id="status1">
                                            <i class="primary"></i>
                                            {{ __('backend.active') }}
                                        </label>
                                        &nbsp; &nbsp;
                                        <label class="md-check">
                                            <input type="radio" name="status" value="0" class="has-value"
                                                {{ $WebmasterSections->status == 0 ? 'checked' : '' }} id="status2">
                                            <i class="danger"></i>
                            ...
                            <div class="form-group row m-t-md">
                                <div class="col-sm-12">
                                    ...
                                    <a href="{{ route('WebmasterSections') }}" class="btn btn-lg btn-default m-t"><i

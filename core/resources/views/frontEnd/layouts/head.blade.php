...
<link href="{{ URL::asset('assets/frontend/css/custom.css') }}?v=86" rel="stylesheet"/>
<link href="{{ URL::asset('assets/frontend/css/matches.css') }}?v=20" rel="stylesheet"/>


@if( @Helper::currentLanguage()->direction=="rtl")
<link href="{{ URL::asset('assets/frontend/css/rtl.css') }}?v=17" rel="stylesheet"/>
@endif

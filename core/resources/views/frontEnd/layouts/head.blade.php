...
<link href="{{ URL::asset('assets/frontend/css/custom.css') }}?v=84" rel="stylesheet"/>
<link href="{{ URL::asset('assets/frontend/css/matches.css') }}?v=16" rel="stylesheet"/>


@if( @Helper::currentLanguage()->direction=="rtl")
<link href="{{ URL::asset('assets/frontend/css/rtl.css') }}?v=15" rel="stylesheet"/>
@endif

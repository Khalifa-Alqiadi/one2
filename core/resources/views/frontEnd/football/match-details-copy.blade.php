                ...
                <div class="col-lg-8">
                    <a href="{{ route('league.rounds', ['id' => $fixture->league->id]) }}" class="league-header mb-3">
                                    ...
                                    <div class="text-center">
                                        ...
                                        @if ($isFinished || $isTimeLive)
                                            <div class="js-scorebox"
                                                style="font-size:28px;font-weight:800;letter-spacing:1px;">
                                                <span class="js-home">{{ $fixture->home_score ?? '-' }}</span>
                                                <span style="opacity:.6;margin:0 10px;">-</span>
                                                <span class="js-away">{{ $fixture->away_score ?? '-' }}</span>
                                            </div>
                                        @endif
                        ...
                        <div class="tab-content">
                            {{-- EVENTS --}}
                            @include('frontEnd.custom.league-fixturees.partials.events')

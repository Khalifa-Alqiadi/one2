...
// Leagues
    ...
    Route::get('/leagues/update/api', [LeaguesController::class, 'update_api'])->name('leaguesUpdateAPI');
    ...
    Route::post('/leagues/rounds/API/{id}', [LeaguesController::class, 'roundsAPI'])->name('leaguesRoundsAPI');
